...
$where=["np.type_np='fractionnee'"];$params=[];
...
cpRapportPageStart("Notes de Perception Fractionnées (NPF)","Suivi des NPF payées, non payées, partielles et défaillantes.");
?>
