...
</style><link rel="stylesheet" href="../../assets/css/corrections.css">
</head>
<body class="cp-corrections-page"><div class="admin-layout"><?php require_once "../../includes/sidebar.php"; ?><main class="main-content"><?php require_once "../../includes/topbar.php"; ?>
<div class="hero"><h2>Liste des corrections</h2><p>Suivi des demandes de correction des documents.</p></div>
<div class="panel cp-corrections-panel"><a class="btn" href="correction_create.php">Nouvelle correction</a><a class="btn btn-gray" href="documents_corriges.php">Documents corrigés</a><a class="btn btn-gray" href="historique.php">Historique</a></div>
<div class="panel cp-corrections-panel"><table class="table-premium cp-corrections-table"><tr><th>ID</th><th>Document</th><th>Type</th><th>Motif</th><th>Statut</th><th>Date</th></tr>
