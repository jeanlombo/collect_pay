...
checkAuth();
requirePermission('controle', 'validate');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!in_array($decision, ['conforme', 'rejeter', 'corriger'])) {
    ...
    <main class="main-content">
        ...
        <div class="verify-box">
            ...
            <div class="verify-header">
                ...
                <p>Montant : <strong><?= number_format($nd['montant_total'] ?: $nd['total_exigible'], 2, ',', ' ') ?> CDF</strong></p>
            </div>
